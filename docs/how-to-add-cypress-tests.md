...
- [Start the freeCodeCamp client application and API server](docs/how-to-setup-freecodecamp-locally#step-4-start-the-freecodecamp-client-application-and-api-server)
